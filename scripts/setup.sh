...
echo "  ✅ Bookinfo:      http://localhost:9080/productpage (要ポートフォワード)"
echo "  ✅ Grafana:       http://localhost:3000 (admin/admin)"
echo "  ✅ Prometheus:    http://localhost:9090"
echo ""
echo "📝 Bookinfoアクセス用のポートフォワード:"
